...
namespace FieldDay.Assets {
    /// <summary>
    /// Preloads a set of content packages.
    /// </summary>
    [PreloadOrder(int.MinValue + 1)]
    public sealed class ContentPackageLoader : MonoBehaviour, IScenePreload {
        [SerializeField] private ContentPack[] m_Packs;
