...
namespace TMPro
{
    ...
    public abstract class TMP_Text : MaskableGraphic
    {
        ...
        public float maxLineWidth {
            ...
            set { if (m_maxLineWidth == value) return; m_maxLineWidth = value; ComputeMarginSize(); m_havePropertiesChanged = true; SetAllDirty(); }
        }
        [SerializeField]
        protected float m_maxLineWidth = 0;
        ...
        */
        ...
        float GetPreferredWidth(Vector2 margin)
        {
            ...
            m_AutoSizeIterationCount = 0;
            float preferredWidth = CalculatePreferredValues(ref fontSize, margin, false, m_TextWrappingMode).x;
